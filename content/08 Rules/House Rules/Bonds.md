...
> _Relationships are not simple. Admiration can exist beside mistrust, affection can go unanswered, and loyalty can survive even when trust begins to fracture._

## Overview

**Bonds** represent the significant emotions one player character feels toward another player character.
...
Each character records only the emotions that **their own character feels** toward another player character.

This means two characters may feel very differently about one another.

---

# Who Can Have Bonds

Bonds may only exist between player characters.
...
Each player character may have up to **six Bonds**.

Each Bond must be with a different player character.

A character may only have one Bond entry for each other player character.
...
Each Bond may contain emotions chosen from three opposing pairs.

|Emotional Pair|Opposing Emotion|
|---|---|
|Admiration|Inferiority|
|Loyalty|Mistrust|
|Affection|Hatred|

A character may select only one emotion from each pair for the same Bond.
...
A Bond's strength is determined by the number of different emotions it contains.

|Bond Strength|Emotions|
|--:|---|
|**1**|One emotion|
|**2**|Two emotions|
|**3**|Three emotions|

Because there are three emotional pairs, a Bond can never exceed Strength 3.

Each emotion must come from a different pair.
...
A Bond may be created after a meaningful interaction or event between two player characters.
...
The Bond begins at **Strength 1**.

The player should briefly explain why their character feels that emotion.
...
The new emotion should reflect what has happened in the story.

The GM may call for an appropriate Ability Check before allowing the Bond to strengthen.
...
A player cannot repeatedly make checks simply to increase a Bond without a meaningful event or interaction.

---

# Directional Bonds

Bonds are always recorded from one character's perspective.

Two players do not share the same Bond.

Each player tracks their own character's emotions independently.

### Example: Rocko and Kyra

Rocko has developed romantic feelings for Kyra.
...
Rocko's Affection does not require Kyra to feel Affection in return.

Kyra's Hatred does not remove or replace Rocko's Affection.

---

# Changing an Emotion

An emotion may change into its opposing emotion after a major affecting event.
...
A Bond may weaken when an emotional connection fades or is resolved.
...
The Bond's strength decreases by 1.

If all emotions are removed, the Bond ends.

The player may later form a new Bond with that character if the relationship changes again.

---

# Using Bonds with Echo Points

A player may spend an **Echo Point** to invoke one of the emotions in a Bond.

The player must explain how that emotion affects their character's actions.

The emotion should be relevant to the situation.
...
> "I spend an Echo Point to invoke my Admiration for Kyra. I remember how she handled this kind of negotiation and follow her example."

---

## Invoking Inferiority
...
> "I spend an Echo Point because I refuse to look weak beside Rocko."
...
> "I spend an Echo Point to reach Kyra before the enemy does. I will not leave her behind."
...
> "I spend an Echo Point to invoke my Mistrust of Rocko. I am watching closely for what he is not saying."
...
> "I spend an Echo Point because Rocko's Affection for Kyra drives him to protect her."
...
> "Kyra spends an Echo Point to invoke her Hatred of Rocko and resist his attempt to persuade her."

---

# Bonding During Downtime

A player may use a downtime activity to develop a Bond with another player character.
...
- Kyra rescued me during the attack on Wyrmsgate.
- My Affection developed after our conversation during the Frostfaire.
- Admiration was added after she defeated the werewolf champion.
...
- Dio concealed important information from the party.
```
